...
class Deposit(models.Model):
    status_choices =(("pending","pending"),("Approved","Approved"),
                        ("Rejected","Rejected"))
    pay_choices =(("banked","banked"),("mobile money","mobile money"),
                        ("cash","cash"))
    ...
    purpose = models.CharField(max_length=50, null=False, choices = purpose_choices)
    year = models.PositiveIntegerField()
    deposited_by = models.CharField(max_length=50,null=False)
    status = models.CharField(max_length=30, null=False, choices = status_choices, default="pending")
    date_created = models.DateTimeField(auto_now_add=True)
    mode_of_payment = models.CharField(max_length=30, null=False, choices = pay_choices)
...
class Expense(models.Model):
    purpose = models.CharField(max_length=30, null=False)
    amount = models.PositiveIntegerField()
